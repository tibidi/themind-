...
[Voir la vidéo](docs/video-preview.png)](https://drive.google.com/file/d/1s8TCaMcN6aU64UrpkEnqQ-4A_gSh-CN_/view)

## AVANT DE COMMENCER

Vérifiez que :
- ✅ Le poêle est allumé
- ✅ Le téléphone est près du poêle
- ✅ Le Bluetooth et le Wi-Fi sont activés
- ✅ Vous avez 10 à 15 minutes devant vous
...
💡 **On repart à zéro, c'est volontaire.**
...
### ❗ SI ÇA BLOQUE (IMPORTANT)

1. Glissez le doigt vers le haut depuis le bas de l'écran
2. Fermez complètement l'application
3. Rouvrez-la
4. Reprenez cette étape
...
2. Vous verrez :
   ...
   - Un bouton gris ⚙️ (en bas)

3. **Appuyez simultanément sur les deux boutons** (rouge et gris) **pendant au moins 10 secondes**

4. Le Bluetooth du poêle sera réactivé
...
💡 **Le guide s'arrête ici, comme la vidéo.**

L'utilisation quotidienne de l'application n'est pas expliquée volontairement. Ce guide couvre uniquement la configuration initiale.
...
4. ✅ Autoriser le Bluetooth et connecter le poêle
5. ✅ Configurer le Wi-Fi et nommer le poêle
6. ✅ Sélectionner le mode Bluetooth
...
**© Guide créé à partir de captures d'écran réelles**
